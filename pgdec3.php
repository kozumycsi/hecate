    ...
    <div class="produto-container">
        <div class="imagens-produto">
            <div class="imagem-principal">
                <img id="imagem-atual" src="../img/comprar5.png" alt="Imagem Principal" />
            </div>
            <div class="imagem-miniaturas">
                <img src="../img/comprar5.png" class="imagem-miniatura" alt="Miniatura 1" onclick="alterarImagem(this)" />
                <img src="../img/comprar5.png" class="imagem-miniatura" alt="Miniatura 2" onclick="alterarImagem(this)" />
                <img src="../img/comprar5.png" class="imagem-miniatura" alt="Miniatura 3" onclick="alterarImagem(this)" />
            </div>
        </div>

        <div class="detalhes-produto">
            <h1>Vestido gótico com renda</h1>
            <p>ID: <span>242424243</span></p>
        ...
        function verificarSelecao() {
            ...
            if (corSelecionada && tamanhoSelecionado) {
                ...
                btnAdicionar.onclick = function() {
                    adicionarAoCarrinho(3, 'Vestido gótico com renda', 189.9, '../img/comprar5.png', corSelecionada, tamanhoSelecionado);
                };
            } else {
