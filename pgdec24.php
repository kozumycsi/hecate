    ...
    <div class="produto-container">
        <div class="imagens-produto">
            <div class="imagem-principal">
                <img id="imagem-atual" src="../img/p24.webp" alt="Imagem Principal" />
            </div>
            <div class="imagem-miniaturas">
                <img src="../img/p24.webp" class="imagem-miniatura" alt="Miniatura 1" onclick="alterarImagem(this)" />
                <img src="../img/p24.webp" class="imagem-miniatura" alt="Miniatura 2" onclick="alterarImagem(this)" />
                <img src="../img/p24.webp" class="imagem-miniatura" alt="Miniatura 3" onclick="alterarImagem(this)" />
            </div>
        </div>

        <div class="detalhes-produto">
            <h1>Vestido gótico com renda</h1>
            <p>ID: <span>2424242424</span></p>
        ...
        function verificarSelecao() {
            ...
            if (corSelecionada && tamanhoSelecionado) {
                ...
                btnAdicionar.onclick = function() {
                    adicionarAoCarrinho(24, 'Vestido gótico com renda', 169.9, '../img/p24.webp', corSelecionada, tamanhoSelecionado);
                };
            } else {
