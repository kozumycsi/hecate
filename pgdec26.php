    ...
    <div class="produto-container">
        <div class="imagens-produto">
            <div class="imagem-principal">
                <img id="imagem-atual" src="../img/p26.webp" alt="Imagem Principal" />
            </div>
            <div class="imagem-miniaturas">
                <img src="../img/p26.webp" class="imagem-miniatura" alt="Miniatura 1" onclick="alterarImagem(this)" />
                <img src="../img/p26.webp" class="imagem-miniatura" alt="Miniatura 2" onclick="alterarImagem(this)" />
                <img src="../img/p26.webp" class="imagem-miniatura" alt="Miniatura 3" onclick="alterarImagem(this)" />
            </div>
        </div>

        <div class="detalhes-produto">
            <h1>Vestido gótico com detalhes</h1>
            <p>ID: <span>2424242426</span></p>
        ...
        function verificarSelecao() {
            ...
            if (corSelecionada && tamanhoSelecionado) {
                ...
                btnAdicionar.onclick = function() {
                    adicionarAoCarrinho(26, 'Vestido gótico com detalhes', 169.9, '../img/p26.webp', corSelecionada, tamanhoSelecionado);
                };
            } else {
