    ...
    <div class="produto-container">
        <div class="imagens-produto">
            <div class="imagem-principal">
                <img id="imagem-atual" src="../img/comprar4.png" alt="Imagem Principal" />
            </div>
            <div class="imagem-miniaturas">
                <img src="../img/comprar4.png" class="imagem-miniatura" alt="Miniatura 1" onclick="alterarImagem(this)" />
                <img src="../img/comprar4.png" class="imagem-miniatura" alt="Miniatura 2" onclick="alterarImagem(this)" />
                <img src="../img/comprar4.png" class="imagem-miniatura" alt="Miniatura 3" onclick="alterarImagem(this)" />
            </div>
        </div>

        <div class="detalhes-produto">
            <h1>Corpse Bride com decote ombro</h1>
            <p>ID: <span>242424242</span></p>
        ...
        function verificarSelecao() {
            ...
            if (corSelecionada && tamanhoSelecionado) {
                ...
                btnAdicionar.onclick = function() {
                    adicionarAoCarrinho(2, 'Corpse Bride com decote ombro', 92.9, '../img/comprar4.png', corSelecionada, tamanhoSelecionado);
                };
            } else {
